...
Readium.Models.CSPaginationStrategySelector = Readium.Models.PaginationStrategySelector.extend({
	...
	renderSpineItems: function(renderToLast, hashFragmentId) {
		...
		// A reflowable epub
			...
			this.v = new Readium.Views.CSReflowablePaginationView({model: book, zoomer: this.zoomer});
		}
